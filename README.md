...
This is protobuf code generation for micro. We use protoc-gen-micro to reduce
boilerplate code.

We previously maintained a [fork](https://github.com/micro/protobuf) of
[golang/protobuf](https://github.com/golang/protobuf) to include the micro
plugin but have since moved to protoc-gen-micro.
...
The micro generated code, `greeter.micro.go`, includes clients and handlers
which reduce boiler plate code,
...
protoc-gen-micro is a liberal reuse of protoc-gen-go hence we maintain the
original license.
